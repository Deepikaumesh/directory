import 'package:directory/catagorycard.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';

import 'Second_search.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Material(
              ...
              child: TextField(
                onTap:(){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Secondsearch()));
                } ,
            ...
            Row(
              ...
              children:[
                Text("Catagoris",style: TextStyle(fontSize: 17),),
                Text("View All>>"),
      ],),
                          ...
                          Container(
                            child: ListView(
                              ...
                              children: [
                                ...
                                CatagoryCard(
                                    urls[0], "Luxary Hotel", "Caroline", ),
                                CatagoryCard(urls[5], "Plaza Hotel", "Italy", ),
                                CatagoryCard(
                                    urls[2], "Safari Hotel", "Africa", ),
                              ],
                            ),
                          ),
                          Container(
                            child: ListView(
                              ...
                              children: [
                                ...
                                CatagoryCard(urls[6], "Visit Rome", "Italy",),
                                CatagoryCard(urls[8], "Visit Sidi bou Said",
                                    "Tunsia"),
                              ],
                            ),
                          ),
